  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 lg:gap-6 @container">
          ...
          <div className="space-y-5">
            ...
            {selectedClient && (
              <div className="space-y-2 animate-in fade-in slide-in-from-top-2">
                <label className="text-sm font-medium text-stone-700">Obra</label>
                <div className="flex gap-2">
      ...
      <Dialog open={showCreateClientDialog} onOpenChange={setShowCreateClientDialog}>
        <DialogContent className="sm:max-w-[600px] w-[min(100vw-2rem,600px)] max-h-[90vh] overflow-y-auto">
      ...
      >
        <DialogContent className="sm:max-w-[700px] w-[min(100vw-2rem,700px)] h-[min(90vh,100dvh)] p-0 flex flex-col overflow-hidden">
