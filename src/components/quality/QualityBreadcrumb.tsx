...
interface QualityBreadcrumbProps {
  hubName: string
  hubHref: string
...
export function QualityBreadcrumb({ hubName, hubHref, items = [], className }: QualityBreadcrumbProps) {
  const all: BreadcrumbItem[] = [
    { label: 'Calidad', href: '/quality/operaciones' },
    { label: hubName, href: hubHref },
    ...items,
  ]
