...
interface Props {
  ...
  avgCementPerM3: number;
}

export function SummaryCards({ totalVolume, totalMaterialCost, weightedAvgCostPerM3, totalCementConsumption, avgCementPerM3 }: Props) {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 mb-6">
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold">{avgCementPerM3.toFixed(1)} kg/m³</div>
          <p className="text-xs text-muted-foreground">Promedio ponderado del período</p>
        </CardContent>
      </Card>
    </div>
  );
