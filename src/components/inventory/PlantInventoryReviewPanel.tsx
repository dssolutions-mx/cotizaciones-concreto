...
export type PlantInventoryReviewPanelProps = {
  workspacePlantId: string
  availablePlants: Array<{ id: string; name: string; code?: string }>
  /** Optional subtitle under "Existencias por material" */
  listDescription?: string
}

export default function PlantInventoryReviewPanel({
  workspacePlantId,
  availablePlants,
  listDescription = 'Stock actual y punto de reorden (kg). Mismos datos que ve dosificador en Control de producción.',
}: PlantInventoryReviewPanelProps) {
  ...
  return (
    <Card className="rounded-lg border border-stone-200 bg-white">
      <CardHeader className="pb-2">
        ...
        <CardDescription className="text-xs text-stone-500">{listDescription}</CardDescription>
