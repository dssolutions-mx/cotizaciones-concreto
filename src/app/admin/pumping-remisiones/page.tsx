...
export default function AdminPumpingRemisionesPage() {
  ...
  // Check permissions
  useEffect(() => {
    if (profile && !hasRole(['EXECUTIVE', 'PLANT_MANAGER'])) {
      router.push('/');
  ...
  return (
    <div className="container mx-auto py-6">
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-900 mb-2">Administración de Remisiones de Bombeo</h1>
        <p className="text-gray-600">Gestiona y revisa todas las remisiones de bombeo con su evidencia</p>
      </div>
                ...
                <div key={remision.id} className="border border-gray-200 rounded-lg p-4">
                  ...
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex-1">
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm text-gray-600">
                        ...
                        <div>
                          <span className="font-medium">Cliente:</span> {remision.orders.clients.name}
                        </div>
                        <div>
                  ...
                  {remision.observaciones && (
                    <div className="mt-4 pt-4 border-t border-gray-200">
                      ...
                      <p className="text-sm text-gray-600">{remision.observaciones}</p>
                    </div>
                  )}
                </div>
              ))}
