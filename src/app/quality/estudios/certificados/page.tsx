  ...
  useEffect(() => {
    const loadMaterials = async () => {
      try {
        ...
        // Si no tiene ni business_unit_id ni plant_id (EXECUTIVE global): ver todos los materiales
            ...
            >
              ...
              <div className="p-4">
                <MaterialCertificateManager
                  ...
                  isAggregate={material.category === 'agregado'}
                />
              </div>
            </div>
          );
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-base text-gray-600 mt-1">
                    Gestione certificados de materiales y plantas
                  </p>
                </div>
              </div>
            </div>
