...
import MaterialSafetySheetManager from '@/components/quality/MaterialSafetySheetManager';
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-base text-gray-600 mt-1">
                    Hojas de datos de seguridad (MSDS) de materiales
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="flex-1">
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-11 h-11 bg-white border-gray-300 rounded-lg text-sm font-bold !text-gray-900 placeholder:text-gray-500 focus:ring-2 focus:ring-blue-600 focus:border-blue-600"
                />
              </div>
            </div>
